...
## What Flask Kit is and what it is not

`Flask Kit` is about [Flask](http://flask.pocoo.org/) project organizing. It's not yet another framework, it's not
some kind of Python battery and it's not a layer on top of the original Flask. Flask Kit is a simple set of class and
function helpers, useful management commands and general project design. That's it.

After some experience with Flask I decided that the most comfortable and the most flexible project file structure for
my new Flask-based projects looks like this:
...
With a set of blueprints, the project file structure will be mostly like this:
...
It's important to remember that Flask is a microframework for small sites and doesn't provide any way to build
